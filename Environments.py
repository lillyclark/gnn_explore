...
class FeatureEnv():
    ...
    def step(self,action):
        ...
        # UPDATE QUEUE
        for n in range(self.num_nodes):
            if new_feature_matrix[n][self.IS_ROBOT]:
                q = new_feature_matrix[n][self.IS_KNOWN_ROBOT] - new_feature_matrix[n][self.IS_KNOWN_ROBOT]
                new_feature_matrix[n][self.ROBOT_QUEUE] = q.sum()
